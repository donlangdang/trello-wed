...
function Board() {
  ...
  const moveCardToDifferentColumn = (currentCardId, prevColumnId, nextColumnId, dndOrderedColumns) => {
    ...
    // xử lí vấn đề khi kéo card cuối cùng ra khỏi column, column rỗng sẽ có placeholder card, cần xóa nó đi trước khi gởi lên BE
  ...
  const deleteColumnDetails = (columnId) => {
    // update dữ liệu chuẩn state board
    const newBoard = { ...board }
    ...
    // gọi api BE
    deleteColumnDetialsAPI(columnId).then(res => {
      toast.success(res?.deleteResult)
      // console.log('🚀 ~ deleteColumnDetialsAPI ~ res:', res)
    })
  }
