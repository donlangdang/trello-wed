  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            description: 'Markdown Syntax (sẽ ở khóa nâng cao nhé)', // cái này giống như cách viết trong file READNE.md
      ...
      },
      {
        ...
        // phía FE tự tạo ra 1 cái card đặc biệt: Placeholder Card, không liên quan tới BE.
        ...
        // "columnId-placrholder-card" (mỗi column chỉ có thể có tối đa 1 cái placeholder Card)
        // quan trọng khi tạo: phải làm đầy đủ: (_id, boardId, columnId, FE_PlaceholderCard)
